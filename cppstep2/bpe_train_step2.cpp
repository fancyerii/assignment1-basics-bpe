...
void fine_grained_pair_counter_diff_v3(emhash8::HashSet<int>& affected_words,
                                    std::unordered_map<int, std::vector<int>> & wordid_encodings,
                                    const std::unordered_map<int, long long> & wordid_counts,
                                    const std::pair<int, int>& merge_pair,
                                    int new_id,
                                    emhash8::HashMap<std::pair<int, int>, emhash8::HashSet<int>, pair_hash>  & pair_wordids,
                                    std::unordered_map<std::pair<int, int>, int, pair_hash> & diff_pairs,
                                    std::unordered_set<std::pair<int, int>, pair_hash> & new_pairs){
...
void updated_affected_word_count_v3(const std::pair<int, int>& merge_pair,
        const emhash8::HashSet<int>& affected_words, 
        std::unordered_map<int, std::vector<int>> & wordid_encodings, 
        const std::unordered_map<int, long long> & wordid_counts,
        emhash8::HashMap<std::pair<int, int>, int, pair_hash> & pair_counts, 
        emhash8::HashMap<std::pair<int, int>, emhash8::HashSet<int>, pair_hash> & pair_wordids, 
        ...
        std::unordered_map<std::pair<int, int>, std::vector<std::vector<int>>, pair_hash> & pair_strings, 
        std::unordered_map<int, std::vector<int>> & vocabulary){
    emhash8::HashSet<int> affected_words_copy(affected_words);
    
    std::unordered_map<std::pair<int, int>, int, pair_hash> diff_pairs;
    std::unordered_set<std::pair<int, int>, pair_hash> new_pairs;

    fine_grained_pair_counter_diff_v3(affected_words_copy, wordid_encodings, wordid_counts, 
                                        merge_pair, new_id, pair_wordids, 
                                        diff_pairs, new_pairs);
...
void bpe_train_step2_v3(int vocab_size,          
    ...
    while(vocabulary.size() < vocab_size){
        ...
        updated_affected_word_count_v3(max_pair, affected_words, wordid_encodings, wordid_counts,
                                    pair_counts, pair_wordids, size, pair_strings, vocabulary);
...
void fine_grained_pair_counter_diff_v4(emhash9::HashSet<int>& affected_words,
                                    std::unordered_map<int, std::vector<int>> & wordid_encodings,
                                    const std::unordered_map<int, long long> & wordid_counts,
                                    const std::pair<int, int>& merge_pair,
                                    int new_id,
...
void updated_affected_word_count_v4(const std::pair<int, int>& merge_pair,
        ...
        std::unordered_map<std::pair<int, int>, std::vector<std::vector<int>>, pair_hash> & pair_strings, 
        std::unordered_map<int, std::vector<int>> & vocabulary){
    emhash9::HashSet<int> affected_words_copy(affected_words);
    
    std::unordered_map<std::pair<int, int>, int, pair_hash> diff_pairs;
    std::unordered_set<std::pair<int, int>, pair_hash> new_pairs;

    fine_grained_pair_counter_diff_v4(affected_words_copy, wordid_encodings, wordid_counts, 
                                        merge_pair, new_id, pair_wordids, 
                                        diff_pairs, new_pairs);
...
void bpe_train_step2_v4(int vocab_size,          
    ...
    while(vocabulary.size() < vocab_size){
        ...
        updated_affected_word_count_v4(max_pair, affected_words, wordid_encodings, wordid_counts,
                                    pair_counts, pair_wordids, size, pair_strings, vocabulary);
...
void fine_grained_pair_counter_diff_v5(const emhash9::HashSet<int>& affected_words,
                                    std::unordered_map<int, std::vector<int>> & wordid_encodings,
                                    const std::unordered_map<int, long long> & wordid_counts,
                                    const std::pair<int, int>& merge_pair,
                                    int new_id,
...
void updated_affected_word_count_v5(const std::pair<int, int>& merge_pair,
        const emhash9::HashSet<int>& affected_words, 
        std::unordered_map<int, std::vector<int>> & wordid_encodings, 
        const std::unordered_map<int, long long> & wordid_counts,
        emhash8::HashMap<std::pair<int, int>, int, pair_hash> & pair_counts, 
    ...
    fine_grained_pair_counter_diff_v5(affected_words_copy, wordid_encodings, wordid_counts, 
                                        merge_pair, new_id, pair_wordids, 
                                        diff_pairs, new_pairs);
    ...
    for(const auto& new_pair : new_pairs){
        ...
        heappush(pair_heap, {pair_counts[new_pair], pair_strings[new_pair], new_pair});
    }
...
void bpe_train_step2_v5(int vocab_size,          
    ...
    while(vocabulary.size() < vocab_size){
        ...
        updated_affected_word_count_v5(max_pair, affected_words, wordid_encodings, wordid_counts,
...
void fine_grained_pair_counter_diff_v6(const emhash9::HashSet<int>& affected_words,
                                    std::unordered_map<int, std::vector<int>> & wordid_encodings,
                                    const std::unordered_map<int, long long> & wordid_counts,
                                    const std::pair<int, int>& merge_pair,
                                    int new_id,
...
void updated_affected_word_count_v6(const std::pair<int, int>& merge_pair,
        const emhash9::HashSet<int>& affected_words, 
        std::unordered_map<int, std::vector<int>> & wordid_encodings, 
        const std::unordered_map<int, long long> & wordid_counts,
        emhash8::HashMap<std::pair<int, int>, int, pair_hash> & pair_counts, 
    ...
    fine_grained_pair_counter_diff_v6(affected_words_copy, wordid_encodings, wordid_counts, 
...
void bpe_train_step2_v6(int vocab_size,          
    ...
    while(vocabulary.size() < vocab_size){
        ...
        updated_affected_word_count_v6(max_pair, affected_words, wordid_encodings, wordid_counts,
                                    pair_counts, pair_wordids, size, pair_strings, vocabulary, pair_heap);
